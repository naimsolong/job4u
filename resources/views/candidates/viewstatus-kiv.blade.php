	...
	<div class="row">
		<div class="col-md col-lg-9">
			<div class="alert alert-info text-center">
				<h2 class="alert-heading"><b>KIV</b></h2>
			</div>
			...
			<div class="input-group mt-3">
				<textarea name="remarks" class="form-control {{ $errors->has('remarks') ? ' is-invalid' : '' }}"> {{old('remarks')?old('remarks'):$application->remarks}}</textarea>
